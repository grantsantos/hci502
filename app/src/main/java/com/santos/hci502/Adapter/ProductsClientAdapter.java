...
public class ProductsClientAdapter extends RecyclerView.Adapter<ProductsClientAdapter.ProductsViewHolder> {

    Context context;
    ArrayList<ProductsModel> inboxList;

    public ProductsClientAdapter(Context context) {
    ...
    @NonNull
    @Override
    public ProductsClientAdapter.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_item_products_customer, parent, false);
        ProductsClientAdapter.ProductsViewHolder productsViewHolder = new ProductsClientAdapter.ProductsViewHolder(itemView, context, inboxList);
        return productsViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull ProductsClientAdapter.ProductsViewHolder holder, int position) {
